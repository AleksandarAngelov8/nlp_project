...
TOKENIZER_ID = os.getenv("GHOSTBUSTER_TOKENIZER_ID", "meta-llama/Llama-2-7b-hf")
llama_tokenizer = AutoTokenizer.from_pretrained(TOKENIZER_ID, use_fast=True)

# Some SP tokenizers don’t define pad_token; safe fallback:
if llama_tokenizer.pad_token is None and hasattr(llama_tokenizer, "eos_token"):
